...
return [
    ...
    |
    */
    'user_model' => config('auth.providers.users.model', Modules\Cockpit\Entities\User::class),
    ...
    */
    ...
    |
    */
    'team_model' => Modules\Cockpit\Services\Teamwork\TeamworkTeam::class,
    ...
    */
    ...
    |
    */
    'invite_model' => Modules\Cockpit\Services\Teamwork\TeamInvite::class,
