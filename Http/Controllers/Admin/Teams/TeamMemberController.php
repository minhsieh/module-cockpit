...
class TeamMemberController extends Controller
{
    ...
    public function destroy($team_id, $user_id)
    {
        ...
        return redirect(action('Admin\Teams\TeamMemberController@show',$team->id))->with('success', 'Detach member "'.$user->name.'" from team "'.$team->name.'" success');
    }
    ...
    public function invite(Request $request, $team_id)
    {
        ...
        return redirect(action('Admin\Teams\TeamMemberController@show', $team->id))->with('success', 'Invite "'.$request->email.' success');
    }
    ...
    public function resendInvite($invite_id)
    {
        ...
        return redirect(action('Admin\Teams\TeamMemberController@show', $invite->team))->with('success', 'Resend invite "'.$request->email.' success');
    }
