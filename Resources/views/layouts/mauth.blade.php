...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('modules/cockpit/pages/css/login.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="{{ url('') }}">
                <img src="{{asset('modules/cockpit/layouts/layout/img/logo.png')}}" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{asset('modules/cockpit/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('modules/cockpit/global/plugins/jquery-validation/js/additional-methods.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('modules/cockpit/pages/scripts/login.js')}}" type="text/javascript"></script>
