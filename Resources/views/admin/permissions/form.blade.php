        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        @if($form_type == 'create') 
                        <i class="fa fa-plus"></i>新增權限
                        @elseif($form_type == 'edit')
                        <i class="fa fa-pencil"></i>編輯權限
                        @endif
                    </div>
                ...
                <div class="portlet-body">
                    <form action="@if($form_type == 'create') {{action('Admin\PermissionController@store')}} @elseif($form_type == 'edit') {{action('Admin\PermissionController@update' , $permission->id)}} @endif" method="POST" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    <div class="tab-content form-horizontal form-bordered">
                        <div class="tab-pane active" id="normal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input name="display_name" type="text" class="form-control" value="{{ old('display_name', $permission->display_name ?? null) }}">
                                </div>
                            </div>
                            <!--Type-->
                            <div class="form-group">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{action('Admin\PermissionController@index')}}" class="btn btn-default"><i class="fa fa-arrow-left"></i> 返回</a>
